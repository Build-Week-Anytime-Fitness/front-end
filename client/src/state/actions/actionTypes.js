...
// classesAction types
export const SEARCH_TERM = "SEARCH_TERM"; //search term for classes changed
export const GET_FILTERED_CLASSES = "GET_FILTERED_CLASSES"; //filtered classes changed
export const ALL_CLASSES = "ALL_CLASSES"; //all classes received/changed. Setting classes in state
...
export const FORM_IS_SUBMITTING_CHANGE = "FORM_IS_SUBMITTING_CHANGE";